 ...
 * 
 * Copied from commons.apache.org/net/examples/ftp/FTPClientExample.java
 */
...
public final class FTPClientExample
{
    ...
    public static void main(String[] args) throws UnknownHostException, BridgeDBException
    {
        AccountInfo info = AccountsReader.findByUri("ftp://ftp.rsc-us.org");
        
        //Added by Christian
        args = new String[5];
        //args[0] = "-l";
        args[0] = "ftp.rsc-us.org";
        args[1] = info.getLogin();
        args[2] = info.getPassword();
        args[3] = "OPS/20130117/void_2013-01-17.ttl";
        args[4] = "c:/temp/cstest.ttl";
