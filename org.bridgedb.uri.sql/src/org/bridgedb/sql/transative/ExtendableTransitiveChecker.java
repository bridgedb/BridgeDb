 ...
 * @author christian
 */
public class ExtendableTransitiveChecker  implements TransitiveChecker{

    private static final ExtendableTransitiveChecker instance = new ExtendableTransitiveChecker();
    
    private static final Set<String> limitedSysCodes;
    static {
        limitedSysCodes = new HashSet<String>();
        limitedSysCodes.addAll(OpsTransitiveChecker.getOpsCodes());
    }

    private ExtendableTransitiveChecker(){
    }
    
    public static ExtendableTransitiveChecker getInstance(){
        return instance;
    }
