...
public class TransitiveTest {
    ...
    public void testTransitiveMappings1A() throws Exception{
        ...
        IdSysCodePair source = new IdSysCodePair("1", sysCodeA);
        Set<IDSysCodePairMapping> mappings = sqlUriMapper.getTransitiveMappings(source, Lens.TEST_LENS_NAME);
   ...
   @Test
    ...
    public void testTransitiveMappings25CAll() throws Exception{
        ...
        Set<IDSysCodePairMapping> mappings = sqlUriMapper.getTransitiveMappings(source, Lens.ALL_LENS_NAME);
