...
public abstract class URLLinkLoaderTest extends URLMapperTestBase {
    ...
    protected static void defaultLoadData() throws IDMapperException{
        ...
        listener.registerProvenanceLink(link1to2);
        ...
        listener.registerProvenanceLink(link1to3);
        ...
        listener.registerProvenanceLink(link2to1);
        ...
        listener.registerProvenanceLink(link2to3);
        ...
        listener.registerProvenanceLink(link3to1);
        ...
        listener.registerProvenanceLink(link3to2);
