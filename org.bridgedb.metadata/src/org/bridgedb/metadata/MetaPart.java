...
public interface MetaPart {
    ...
    //public void loadFromInput(InputMetaData metaData, RDFData input);

    public boolean hasRequiredValues(RequirementLevel requirementLevel);

    public boolean hasCorrectTypes();

    public void appendValidityReport(StringBuilder builder, InputMetaData parent, RequirementLevel forceLevel, 
