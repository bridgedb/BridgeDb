...
public abstract class ProvenanceFactoryTest extends IDMapperTestBase {
    ...
    public static final String TEST_PREDICATE = "http://www.bridgedb.org/test#testPredicate";
    /**
    ...
    public void testCreateProvenance_3args() throws Exception {
        ...
        long creation = 1000;
        Provenance result = factory.createProvenance(DataSource1, TEST_PREDICATE, DataSource2, createdBy, creation);
    ...
    public void testCreateProvenance_3argsSourceEqualsTarget() throws Exception {
        ...
        long creation = 1000;
        Provenance result = factory.createProvenance(DataSource1, TEST_PREDICATE, DataSource1, createdBy, creation);
        assertEquals(DataSource1, result.getSource());
        assertEquals(TEST_PREDICATE, result.getPredicate());
