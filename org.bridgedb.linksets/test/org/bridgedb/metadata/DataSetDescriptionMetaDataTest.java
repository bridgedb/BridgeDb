...
public class DataSetDescriptionMetaDataTest extends DataSetMetaDataTest{
    ...
    public void testShowAll(){
        ...
        RDFData input = loadRDFData();
        DatasetDescriptionMetaData metaData = new DatasetDescriptionMetaData(DESCRIPTION_ID, input);
    ...
    public void testHasRequiredValues(){
        ...
        DatasetDescriptionMetaData metaData = new DatasetDescriptionMetaData(DESCRIPTION_ID, loadRDFData());
    ...
    public void testAutoFindId(){
        ...
        DatasetDescriptionMetaData metaData = new DatasetDescriptionMetaData(loadRDFData());
        assertTrue(metaData.hasRequiredValues(RequirementLevel.MUST, ALLOW_ALTERATIVES));
        //assertFalse(metaData.hasRequiredValues(RequirementLevel.MAY, ALLOW_ALTERATIVES));
    } 
    ...
    public void testHasCorrectTypes(){
        ...
        DatasetDescriptionMetaData metaData = new DatasetDescriptionMetaData(ID, loadRDFData());
