...
public class SetupLoaderWithTestData {
   ...
   public static void main(String[] args) throws BridgeDBException {
        ...
        linksetLoader.load("../org.bridgedb.linksets/test-data/cs-cm_test_lens.ttl", StoreType.LOAD, ValidationType.LINKSMINIMAL);
        linksetLoader.load("../org.bridgedb.linksets/test-data/cw-cm_test_lens.ttl", StoreType.LOAD, ValidationType.LINKSMINIMAL);
