...
Usage depends on which module you require. The examples below assumes artifact `org.bridgedb.bio` and version `3.0.11`:
...
```gradle
compile group: 'org.bridgedb', name: 'org.bridgedb.bio', version: '3.0.11'
```

For [Ivy](http://ant.apache.org/ivy/):

```xml
<dependency org="org.bridgedb" name="org.bridgedb.bio" rev="3.0.11"/>
```

For [Buildr](https://buildr.apache.org/):

```buildr
'org.bridgedb:org.bridgedb.bio:jar:3.0.11'
```
