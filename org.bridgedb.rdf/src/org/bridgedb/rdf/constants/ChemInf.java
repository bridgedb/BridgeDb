...
public class ChemInf {
    ...
    public static final String isIsotopologueOf = PREFIX + "CHEMINF_000455";
    ...
    public static final String isStereoisomerOf = PREFIX + "CHEMINF_000461";
    ...
    public static final String isIsotopicallyUnspecifiedParentOf = PREFIX + "CHEMINF_000489";
    public static final String isStereoundefinedParentOf = PREFIX + "CHEMINF_000491";
    public static final String isComponentWithUnchargedCounterpartOf = PREFIX + "CHEMINF_000492";
    public static final String isOPSNormalizedCounterpartOf = PREFIX + "CHEMINF_000494";
    public static final String isUnchargedCounterpartOf = PREFIX + "CHEMINF_000495";
    public static final String isCounterpartWithDifferentChargeOf = PREFIX + "CHEMINF_000497";
    public static final String sharesOPSNormalizedParentWith = PREFIX + "CHEMINF_000498";
    public static final String hasChemAxonCanonicalisedTautomer = PREFIX + "CHEMINF_000499";
    public static final String isChemAxonCanonicalisedTtautomerOf = PREFIX + "CHEMINF_000514";
