 ...
 * @author Christian
 */
public class SimpleLinksetHandler extends RDFHandlerBase{
    ...
    public SimpleLinksetHandler(URLLinkListener listener) throws IDMapperException{
    ...
    private void finishProcessingHeader() throws RDFHandlerException {
        ...
        try {
            ...
            System.out.println(subjectTarget.toString());
    ...
    private void insertLink(Statement st) throws RDFHandlerException {
        try {
            ...
            listener.insertLink(subjectURI.stringValue(), objectURI.stringValue(), provenance);
