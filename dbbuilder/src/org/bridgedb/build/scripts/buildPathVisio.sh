...
mysql -u genmapp -pfun4genmapp < PathVisioMySQL_BEEF.sql
mysqldump --skip-add-locks --skip-disable-keys --skip-quote-names --net_buffer_length=30K -u genmapp -pfun4genmapp ${Database} > ${Database}.sql.dump
